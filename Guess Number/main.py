...
def guess(n):
    ...
    while guess != random_number:
        ...
        if guess > random_number:
            computer_says('Your guess is to high. Guess again.')
        elif guess < random_number:
            computer_says('Your guess is to low. Guess again.')
    computer_says(
        f"Yes. it's {random_number}. You guessed the number I had in mind.")
...
def computer_guess(n):
    ...
    while feedback != 'c':
        ...
        computer_says(
            f"Is it {guess}? " + "Please enter (H) if too high, (L) if too low, or (C) if it's correct.")
    ...
    computer_says(f"Thank you for playing with me.")
